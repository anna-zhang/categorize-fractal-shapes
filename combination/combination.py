...
def main():
    ...
    if program_mode == "-specific": # compare two specific images
        ...
        # write histogram cutoff score
        # write category name
        # write reference image name of category
        # write uncategorized image that matches and the histogram match score
        # write total number of images in category

        # write dictionary of all images and where they were categorized
